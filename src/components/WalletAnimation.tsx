    ...
    >
      <defs>
        <linearGradient id="walletBody" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="hsl(217, 91%, 40%)" stopOpacity="0.85" />
        </linearGradient>
        ...
        <linearGradient id="coinGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="hsl(217, 91%, 48%)" />
        </linearGradient>
        <filter id="softShadow">
          <feDropShadow dx="0" dy="3" stdDeviation="6" floodColor="hsl(217,91%,50%)" floodOpacity="0.25" />
        </filter>
      ...
      <motion.circle
        cx="80" cy="85" r="50"
        fill="hsl(217,91%,50%)" opacity="0.05"
      ...
      <motion.g filter="url(#softShadow)" animate={{ y: [0, -3, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}>
        ...
        <rect x="92" y="82" width="28" height="16" rx="4" fill="hsl(217,91%,40%)" opacity="0.45" />
        <circle cx="80" cy="65" r="4" fill="hsl(199,89%,58%)" stroke="hsl(217,91%,40%)" strokeWidth="1.2" />
      </motion.g>
      ...
      {[
        ...
        <motion.circle
          ...
          fill="url(#coinGrad)" stroke="hsl(217,91%,40%)" strokeWidth="0.8"
