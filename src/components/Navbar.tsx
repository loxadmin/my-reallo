                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="glass-strong min-w-[180px] rounded-2xl p-2 mt-2">
                    ...
                    {isAdmin && (
                      <DropdownMenuItem
                        onClick={() => navigate("/admin")}
                        className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm text-primary"
                      >
                    ...
                    {!isDashboard && (
                      <DropdownMenuItem
                        onClick={() => navigate("/dashboard")}
                        className="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm text-muted-foreground"
                      >
