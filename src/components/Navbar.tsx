          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="p-2 rounded-xl glass-button text-muted-foreground"
                title="Sign Out"
              >
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 glass rounded-xl">
              ...
              <span className="text-[10px] text-muted-foreground font-display font-bold uppercase tracking-wider">Live</span>
            </div>
          )}
        </div>
      </div>
