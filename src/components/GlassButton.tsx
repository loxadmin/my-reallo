...
const GlassButton = ({
  ...
  return (
    <motion.button
      ...
      className={cn(
        "px-6 py-3 rounded-2xl font-display text-sm font-medium tracking-[0.01em] leading-none transition-all duration-300 flex items-center justify-center gap-2",
        variants[variant],
