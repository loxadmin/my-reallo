              ...
              <GlassCard variant="glow">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] text-muted-foreground">How much per month?</p>
                  </div>
                </div>
          ...
          {step === 4 && (
            <motion.div key="step4" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5 }}>
              <GlassCard variant="glow" className="text-center">
                <motion.p className="text-[13px] text-muted-foreground uppercase tracking-widest mb-2" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
                ...
                <motion.p className="text-[13px] text-muted-foreground mb-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}>
