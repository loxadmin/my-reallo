    ...
    <motion.svg width={w} height={h} viewBox={`0 0 ${w} ${h}`} className="inline-block mr-1.5" style={{ verticalAlign: "middle", marginBottom: 2 }}>
      <defs>
        <radialGradient id="irisGrad" cx="50%" cy="50%" r="50%">
          ...
          <stop offset="70%" stopColor="hsl(270, 100%, 60%)" />
      ...
      <motion.path
        ...
        transition={{ times: [0, 0.4, 1], duration: 0.25, repeat: Infinity, repeatDelay: 3 }}
        fill="none" stroke="hsl(270, 100%, 60%)" strokeWidth="2" filter="url(#eyeGlow)"
      />
      ...
      >
        <path
          ...
          fill="none" stroke="hsl(270, 100%, 60%)" strokeWidth="1.2" strokeLinecap="round"
        />
      </motion.g>
      ...
      <motion.path
        ...
        transition={{ times: [0, 0.4, 1], duration: 0.25, repeat: Infinity, repeatDelay: 3 }}
        fill="none" stroke="hsl(270, 100%, 60%)" strokeWidth="2.5" strokeLinecap="round" filter="url(#eyeGlow)"
      />
    </motion.svg>
  );
};
