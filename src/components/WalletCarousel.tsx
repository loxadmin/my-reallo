                ...
                {wallet.active ? (
                  ...
                  <div className="py-4 text-center">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-primary text-primary-foreground text-[13px] font-medium hover:bg-primary/90 transition-colors"
                    >
                      Activate
                    </button>
                  </div>
