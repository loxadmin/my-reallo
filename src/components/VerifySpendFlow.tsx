      ...
      <GlassCard variant="strong" className="space-y-5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">All categories verified</p>
          </div>
        </div>
        <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="glass rounded-2xl p-5 text-center border border-primary/20">
          ...
          <p className="text-sm text-muted-foreground">Total Verified Annual Spend</p>
          ...
          <div className="space-y-4">
            ...
            {type === "data" && (
              <div className="space-y-2.5">
                <p className="text-sm text-muted-foreground font-medium">How often do you buy data?</p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-sm px-2 py-0.5 rounded-full border font-medium ${config.badgeClass}`}>
                    {config.label}
                  </span>
                </div>
    ...
    <div className="space-y-4">
      ...
      <div className="glass rounded-xl p-3.5 space-y-2.5">
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-medium text-foreground capitalize">{verification.frequency}</span>
        </div>
      ...
      {/* Transaction inputs */}
      <div className="space-y-2">
        <p className="text-sm font-medium text-foreground">Transaction IDs</p>
            ...
            return (
              <div key={idx} className="space-y-1">
                ...
                {isDuplicate && !isEditing && canEdit && (
                  <p className="text-sm text-destructive/80 ml-7 flex items-center gap-1">
