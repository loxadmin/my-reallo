          ...
          return (
            <GlassCard variant="glow" className="space-y-4">
              ...
              {switchApp.referral_message && (
                <p className="text-sm text-muted-foreground">{switchApp.referral_message}</p>
              )}
                ...
                return (
                  <GlassCard key={resp.id} className="p-4" animate={false}>
                    ...
                    {(app.category === "yes_no" || app.category === "robust") && resp.switch_completed && (
                      <p className="text-sm text-primary mt-2">✓ Switched</p>
                    )}
                    ...
                    {app.category === "referral" && resp.referral_screenshot_url && !resp.referral_approved && (
                      <p className="text-sm text-muted-foreground mt-2">📋 Screenshot pending admin review</p>
                    )}

                    {app.category === "referral" && resp.referral_approved && (
                      <p className="text-sm text-primary mt-2">✓ Approved — {app.referral_points} pts awarded</p>
                    )}
                  </GlassCard>
                );
              })}
          ...
          {unansweredApps.map((app) => (
            ...
            >
              ...
              <div className={`w-5 h-5 rounded-md border-2 flex items-center justify-center transition-all ${
                ...
                {selectedApps.has(app.id) && <span className="text-primary-foreground text-xs">✓</span>}
              </div>
            </button>
          ))}
        </div>
            ...
            <GlassCard key={survey.id} className="p-4 overflow-hidden relative">
              ...
              {isInProgress && (
                <div className="mt-3 space-y-2">
                  <div className="flex items-center gap-2 text-sm text-accent-foreground bg-accent/10 p-2 rounded-lg border border-accent/20">
              ...
              {isExpiredRestartable && (
                <div className="mt-3 space-y-2">
                  <div className="flex items-center gap-2 text-sm text-destructive bg-destructive/10 p-2 rounded-lg border border-destructive/20">
                    <Clock className="w-3.5 h-3.5" />
              ...
              {isPending && (
                <div className="mt-3 flex items-center gap-2 text-sm text-accent-foreground bg-accent/10 p-2 rounded-lg border border-accent/20">
              ...
              {isApproved && (
                <div className="mt-3 flex items-center gap-2 text-sm text-primary bg-primary/10 p-2 rounded-lg border border-primary/20">
