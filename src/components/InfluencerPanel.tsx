      ...
      <div className="space-y-5 sm:space-y-6">
          ...
          <GlassCard variant="glow" className="p-6 sm:p-8">
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_220px] lg:items-end">
              ...
              <div className="space-y-2 lg:text-right">
                <GlassButton variant="primary" onClick={() => setTab("withdraw")} className="w-full lg:w-auto text-[12px]">
                  <ArrowDownToLine className="w-3.5 h-3.5 mr-1" /> Request Withdrawal
                </GlassButton>
        ...
        <GlassCard className="p-2.5 sm:p-3">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
            <button onClick={() => setTab("overview")} className={`py-2 rounded-lg text-[12px] font-medium transition-all ${tab === "overview" ? "clay-primary text-primary-foreground" : "glass-button text-muted-foreground"}`}>
              Overview
            </button>
            <button onClick={() => setTab("surveys")} className={`py-2 rounded-lg text-[12px] font-medium transition-all ${tab === "surveys" ? "clay-primary text-primary-foreground" : "glass-button text-muted-foreground"}`}>
              Surveys
            </button>
            <button onClick={() => setTab("challenges")} className={`py-2 rounded-lg text-[12px] font-medium transition-all ${tab === "challenges" ? "clay-primary text-primary-foreground" : "glass-button text-muted-foreground"}`}>
              Challenges
            </button>
            <button onClick={() => setTab("withdraw")} className={`py-2 rounded-lg text-[12px] font-medium transition-all ${tab === "withdraw" ? "clay-primary text-primary-foreground" : "glass-button text-muted-foreground"}`}>
              Withdraw
            </button>
          </div>
        </GlassCard>
