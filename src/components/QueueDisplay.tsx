              ...
              <GlassCard className="p-4">
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Next Advance</p>
                  </div>
                  <div className="text-center">
                    <p className="text-sm font-bold text-foreground">50/day</p>
                    <p className="text-sm text-muted-foreground">Auto Skip</p>
                  </div>
                </div>
            ...
            {referralLink && (
              <GlassCard className="p-4">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-muted-foreground font-medium">Your Referral Link</p>
                  <button onClick={handleCopy} className="text-primary text-sm font-medium flex items-center gap-1">
            ...
            {referredUsers.length > 0 && (
              <GlassCard className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm text-muted-foreground font-medium">Your Referred Users ({referredUsers.length})</p>
                </div>
          ...
          <motion.div key="earn-group" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <GlassCard variant="strong" className="text-center">
              <div className="flex items-center justify-center gap-2 mb-1">
                <Award className="w-4 h-4 text-primary" />
                <p className="text-muted-foreground uppercase tracking-[0.14em] text-xs">Points Balance</p>
              </div>
              <h2 className="font-display text-2xl font-bold gradient-text">{pointsBalance.toLocaleString()}</h2>
              <p className="text-muted-foreground mt-1 text-sm">= {formatNaira(nairaValue)} value</p>
            </GlassCard>
          ...
          <motion.div key="goal" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
            <GlassCard>
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-muted-foreground uppercase tracking-[0.12em] text-xs">Your Goal</p>
                  <p className="font-semibold text-foreground text-sm">GOAL - {goalLabels[goal] || goal}</p>
                </div>
                <div className="text-right">
                  <p className="text-muted-foreground uppercase tracking-[0.12em] text-xs">Claimable</p>
              ...
              <p className="text-muted-foreground mt-2 text-sm">{formatNaira(nairaValue)} / {formatNaira(targetAmount)}</p>
