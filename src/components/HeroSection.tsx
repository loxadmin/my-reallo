    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="text-xs font-medium text-muted-foreground tracking-[0.12em] uppercase">
        ...
        >
          <div className="glass-stat rounded-2xl px-3 py-4 text-center">
            ...
            <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1 opacity-80">In Queue</p>
          </div>
          <div className="glass-stat rounded-2xl px-3 py-4 text-center">
            ...
            <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1 opacity-80">To Join</p>
          </div>
          <div className="glass-stat rounded-2xl px-3 py-4 text-center">
            ...
            <p className="text-xs text-muted-foreground font-medium uppercase tracking-wider mt-1 opacity-80">Skip / Referral</p>
          </div>
        </motion.div>
      </motion.div>
