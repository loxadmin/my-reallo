    ...
    >
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <span className="text-sm text-foreground font-semibold">{current.label}</span>
          <span className="text-xs text-muted-foreground uppercase tracking-wider font-bold opacity-60">{config.verb}</span>
