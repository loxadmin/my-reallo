  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-primary/6 rounded-full blur-[220px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[400px] h-[400px] bg-accent/4 rounded-full blur-[160px]" />
      </div>
      <Navbar />
          ...
          <GlassCard variant="glow">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {error && (
                  <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-sm text-destructive font-display">
                    {error}
                  </motion.p>
                )}

                <GlassButton variant="primary" className="w-full mt-4 text-base py-3.5" onClick={handleSubmit} disabled={loading || !email || !password}>
